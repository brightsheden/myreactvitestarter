...
import { useAddRecord } from '../ApiHooks/equipemt';
...
const AddRecord = () => {
  ...
  const {mutate:addrecord,  isLoading,isSuccess, error} = useAddRecord(token)
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Spare Utilized:', spareUtilized);
